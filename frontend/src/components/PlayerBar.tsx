  ...
  return (
    <footer className="player glass">
      ...
      <button
        ...
        title={
          captionsEnabled
            ...
            : 'Needs whisper.cpp — set WHISPER_MODEL_PATH and install whisper-server'
        }
      >
        CC
      </button>
      ...
      <button
        ...
        title={
          quizEnabled
            ? 'Capture a minute of this station and quiz yourself'
            : 'Needs Ollama — run ollama pull qwen2.5:7b-instruct'
        }
      >
        Quiz me
      </button>
