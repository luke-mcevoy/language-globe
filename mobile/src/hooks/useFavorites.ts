...
import { ApiError, addFavorite, getFavorites, removeFavorite } from '../lib/api';
...
/**
 * Mobile-side owner of the favorites list. Mirrors the web hook: same shape,
 * same optimistic behaviour, so the UI works identically.
 */
